 ...
 */
object SecureBankSigningKeyStore {
    private const val DIRECTORY = "bank_signing"
    private const val FILE_NAME = "saved_bank_signing_key.p12"
    private const val PREFS_NAME = "nika_business_bank_signing_key"
    ...
    fun saveFromUri(context: Context, source: Uri): String {
        ...
        val name = queryDisplayName(context, source) ?: "Сохранённая банковская ЭЦП"
